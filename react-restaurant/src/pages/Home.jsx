            ...
            <div className='container my-5'>
                <div className='row'>
                    ...
                    <div className='col-lg-6 d-flex flex-column align-items-center justify-content-center'>
                        ...
                        <p>At React Restaurant, we serve fresh, delicious meals made from the finest ingredients. Our passion for great food and exceptional service ensures every dining experience is memorable</p>
                        <p className='mb-5'>Offers a cozy atmosphere where every dish is crafted with love and care. From our signature recipes to our friendly staff, we promise a dining experience that feels like home.</p>
                        <Link to="/about">
                        ...
                        <div className='col-lg-6 d-flex flex-column align-items-center mb-5 mb-lg-0'>
                            ...
                            <ul className='px-0'>
                                <li className='d-flex justify-content-between'>
                                    <p className='fs-3 mx-2'>Tamil Breakfast</p>
                                    <p className='fs-3 mx-2 text-success fw-nold'>₹12</p>
                                </li>
                                <li className='d-flex justify-content-between'>
                                    <p className='fs-3 mx-2'>Chettinad Kozhi kuzhambu</p>
                                    <p className='fs-3 mx-2 text-success fw-nold'>₹15</p>
                                </li>
                                <li className='d-flex justify-content-between'>
                                    <p className='fs-3 mx-2'>Indian yipee</p>
